...
function getDefaultBiometricsReason(phase: string): string {
    switch (phase) {
        case "Menstrual": return "Focus on iron and warming foods to replenish lost blood and soothe cramps.";
        case "Follicular": return "High carb & protein to support rising estrogen and muscle repair.";
        case "Ovulatory": return "Peak carbohydrates to sustain high-intensity performance.";
        case "Luteal": return "Complex carbs and magnesium to combat PMS cravings and stabilize mood.";
        default: return "Balanced nutrition for general health.";
    }
}
