...
-- ==========================================
-- 2. USER ONBOARDING (Health Metrics)
-- ==========================================
...
-- ==========================================
-- 5. DAILY LOGS (Symptom Tracking) [NEW]
-- ==========================================
create table daily_logs (
  ...
  -- Ensures a user can only have one log entry per calendar date
...
alter table daily_logs enable row level security; -- [NEW]
