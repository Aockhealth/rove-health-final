...
const GOAL_OPTIONS = [
  ...
  { id: "weight_loss", label: "Weight Loss", desc: "Manage weight sustainably" },
  { id: "pcos", label: "PCOS Guidance", desc: "Manage symptoms" },
  { id: "other", label: "General Wellness", desc: "Improve energy & mood" },
  { id: "learn_body", label: "Learn About Body", desc: "Understand your physiology" },
];
...
const getGoalIcon = (id: string, isSelected: boolean) => {
  ...
  switch (id) {
    ...
    case "weight_loss": return <Scale className={className} />;
    case "pcos": return <HeartPulse className={className} />;
    case "learn_body": return <BookOpen className={className} />;
