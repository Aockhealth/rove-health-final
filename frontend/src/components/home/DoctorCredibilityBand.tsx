      ...
      <Reveal className="mx-auto flex max-w-4xl flex-col items-center gap-8 text-center">
        <div className="flex -space-x-4">
          {[0, 1].map((i) => (
            <div
              key={i}
              className="flex h-16 w-16 items-center justify-center rounded-full border-4 border-taupe-light bg-white text-obsidian/60 shadow-sm"
            >
        ...
        <h2 className="font-sans text-2xl font-semibold leading-snug tracking-tight text-obsidian md:text-3xl">
          Formulated by doctors. Backed by research.
        </h2>
