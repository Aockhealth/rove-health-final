    ...
    <section className="relative overflow-hidden bg-taupe-light">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-center gap-12 px-6 pb-24 pt-14 text-center md:grid md:grid-cols-[1.1fr_0.9fr] md:gap-10 md:pb-24 md:pt-20 md:text-left">
        <div className="flex flex-col items-center md:items-start">
          ...
          >
            A cycle app that reads your body,{" "}
            <span className="font-serif italic font-medium">not just your dates.</span>
          </h1>
          ...
          >
            Rove learns your cycle from what you log, and tells you what to do with it — for the
          ...
          <p
            ...
            style={{ animationDelay: "240ms" }}
          >
            Rove learns your cycle from what you actually log, tells you what it means, and gives
            you something to act on — food, movement, and supplements matched to your phase.
          </p>
