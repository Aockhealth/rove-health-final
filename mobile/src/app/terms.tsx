...
// In-app only — no web equivalent. Mirrors the structure of ./privacy.tsx
// (native screen, not a webview/external link) rather than the frontend/'s
// Next.js page, since Terms of Service isn't published on the marketing site.
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FAF9F6' }}>
      ...
      <ScrollView className="flex-1 px-6 pt-6 pb-12" showsVerticalScrollIndicator={false}>
        <View className="inline-flex flex-row items-center gap-2 px-3 py-1.5 mb-6 rounded-full bg-rove-stone/10 self-start">
          <Text className="text-[10px] font-bold uppercase tracking-[2px] text-rove-stone">Legal</Text>
        </View>

        <Text className="text-4xl text-rove-charcoal mb-6" style={{ fontFamily: 'CormorantGaramond-Bold' }}>
          Terms of Service
        </Text>

        <Text className="text-base text-rove-stone mb-2 leading-relaxed font-medium">
        ...
        <View className="gap-8 mb-12">
          ...
          {/* Section 2 — highlighted, matching Privacy's medical-disclaimer treatment */}
          <View className="bg-white rounded-3xl p-6 border border-[#AF6B6B]/20 shadow-sm">
            <Text className="text-xl text-rove-charcoal font-bold mb-4" style={{ fontFamily: 'CormorantGaramond-Bold' }}>
