...
export function PhaseOrbRing({ colors, size = 220 }: { colors: readonly [string, string, ...string[]]; size?: number }) {
  ...
  return (
    <GestureDetector gesture={panGesture}>
      <Animated.View style={[{ width: size, height: size, justifyContent: 'center', alignItems: 'center', position: 'absolute', shadowColor: colors[0], shadowRadius: 35, shadowOpacity: 0.8, shadowOffset: { width: 0, height: 0 }, elevation: 15 }]}>
