import type { OnboardingDraftV2, SymptomInput } from '@shared/onboarding/types';
import { addDays, compareDateStrings, formatLocalDate, parseLocalDate } from '@shared/onboarding/date';
